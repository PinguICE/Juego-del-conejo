...
function preload()
{
  ...
  onestar = loadAnimation('onestar.png');
  twostar = loadAnimation('stars.png');
  stars = loadAnimation('empty.png');
...
function setup() 
{
  ...
  stardisplay.addAnimation('empty',stars);
  stardisplay.addAnimation('one',onestar);
  stardisplay.addAnimation('two',twostar);
  stardisplay.changeAnimation('empty');

  star1 = createSprite(320,50);
  star1.addImage(starimg);
  star1.scale = 0.02 

  star2 = createSprite(50,370);
  star2.addImage(starimg);
  star2.scale = 0.02 

  voton = createImg('baloon2.png');
  voton.position(260,370);
  voton.size(120,119);
  voton.mouseClicked(airglobo);
